...
describe 'MonitorModel led con hdmi' do
  ...
  before :each do
    @monitor = Object.new.extend(TecnologyBuilder.monitor_con_ppp_y_size(50,120)).extend(Lsd).extend(VGA)
  end
  ...
  it 'EL consumo debe ser 55 watts/h' do
    ...
    expect(@monitor.consumption).to eq 200.58787753826797
  end
  ...
  it 'La definicion maxima debe ser 480' do
    ...
    expect(@monitor.max_definition).to eq 587.8775382679627
  end
end