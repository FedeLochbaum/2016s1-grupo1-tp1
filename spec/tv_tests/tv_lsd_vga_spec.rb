...
describe 'Tv led con hdmi' do
  ...
  before :each do
    @tv = Object.new.extend(TecnologyBuilder.tv_con_ppp_with_size(50,120)).extend(Lsd).extend(VGA)
  end
  ...
  it 'EL consumo debe ser 55 watts/h' do
    ...
    expect(@tv.consumption).to eq 200.58787753826797
  end
  ...
  it 'La definicion maxima debe ser 480' do
    ...
    expect(@tv.max_definition).to eq 587.8775382679627
  end
end